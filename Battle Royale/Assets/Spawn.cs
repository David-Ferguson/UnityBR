...
public class Spawn : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        gameObject.GetComponent<Renderer>().material.color = new Color(GameObject.Find("Players").GetComponent<Spawner>().rand.Next(0, 200)/255f, GameObject.Find("Players").GetComponent<Spawner>().rand.Next(0, 200)/255f, GameObject.Find("Players").GetComponent<Spawner>().rand.Next(0, 200)/255f, 1.0f);
